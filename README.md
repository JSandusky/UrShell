...
ATF is a flicking nightmare. It's an absolutely awesome toolkit, but it draws terribly.

Bindings are C++/CLI and autogenerated, made them incredibly brittle. A change in how the bindings are output breaks everything using them.
