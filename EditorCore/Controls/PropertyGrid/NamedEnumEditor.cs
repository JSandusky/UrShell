...
namespace EditorCore.Controls.PropertyGrid
{
    ...
    public class NamedEnumEditor : UITypeEditor, IAnnotatedParams
    {
        /// <summary>
        /// Default constructor</summary>
        public NamedEnumEditor()
        {
        }
        ...
        public NamedEnumEditor(string[] names)
        {
            DefineEnum(names);
        }
        ...
        public NamedEnumEditor(string[] names, int[] values)
        {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (m_editorService != null)
            {
                ...
                listBox.ItemHeight = (int)(listBox.ItemHeight * 1.5);
                ...
                using (Graphics g = listBox.CreateGraphics())
                {
                    ...
                    {
                        SizeF size = g.MeasureString(name, listBox.Font);
                        float w = size.Width;
                        height += size.Height;
