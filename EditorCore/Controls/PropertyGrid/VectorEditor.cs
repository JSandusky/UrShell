...
namespace EditorCore.Controls.PropertyGrid
{
    ...
    public class VectorEditor : UITypeEditor, IPropertyEditor, IAnnotatedParams
    {
        /// <summary>
        ...
        public VectorEditor(Type numericType, string[] names)
        {
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (editorService != null)
            {
                VectorControl control =
                    new VectorControl(m_numericType, m_names);
                control.HideAxisLabel = HideAxisLabel;
                control.SetLabelBackColors(m_labelColors);
                if (value != null)
                    control.Value = value as UrhoBackend.MathVector;
        ...
        private class InVectorControl : VectorControl, ICacheablePropertyControl
        {
            ...
            protected override void OnValueChanged(EventArgs e)
            {
                ...
                {
                    object val = Value;
                    if (m_context.Descriptor.Converter != null)
                        val = m_context.Descriptor.Converter.ConvertTo(val, m_numericType);
