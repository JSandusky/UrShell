...
namespace EditorCore.Controls.PropertyGrid
{
    ...
    public class ResourceRefEditor : FileNameEditor, IAnnotatedParams
    {
        /// <summary>
        /// Constructor</summary>
        public ResourceRefEditor()
        {
        }
        ...
        public ResourceRefEditor(string filter)
        {
            m_filter = filter;
        }
