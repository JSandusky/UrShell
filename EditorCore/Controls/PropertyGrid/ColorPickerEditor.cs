...
namespace EditorCore.Controls.PropertyGrid
{
    ...
    public class ColorPickerEditor : ColorEditor
    {
            ...
            object value)
        {
            ...
            {
                Color val = (context.PropertyDescriptor.Converter != null) ?
                    (Color)context.PropertyDescriptor.Converter.ConvertTo(value, typeof(Color)) : (Color)value;

                ColorPicker picker = new ColorPicker(val, m_enableAlpha);
