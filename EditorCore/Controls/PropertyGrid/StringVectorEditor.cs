...
namespace EditorCore.Controls.PropertyGrid
{
    ...
    public class StringVectorEditor : UITypeEditor, IPropertyEditor, IAnnotatedParams
    {
        /// <summary>
        ...
        public StringVectorEditor(Type numericType, string[] names)
        {
        ...
        private class InVectorControl : VectorControl, ICacheablePropertyControl
        {
            ...
            private void RefreshValue()
            {
                try
                {
                    ...
                    {
                        base.Value = value as UrhoBackend.MathVector;
