...
namespace UrhoBackend {
    ...
    public ref class VectorBuffer {
    public:
        VectorBuffer(Urho3D::VectorBuffer* comp);
        VectorBuffer(System::IntPtr^ ptr);
        VectorBuffer(System::String^ string);
        ~VectorBuffer();
...
// Methods
        VectorBuffer^ opAssign(VectorBuffer^);
        void Clear();
...
// Fields
        ...
        Urho3D::VectorBuffer* vectorbuffer_;
    };
}
