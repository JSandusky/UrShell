...
namespace UrhoBackend {
    ...
    public ref class Deserializer {
    public:
        Deserializer(Urho3D::Deserializer* comp);
        Deserializer(System::IntPtr^ ptr);
        Deserializer(System::String text);
        ~Deserializer();
...
// Fields
        ...
        Urho3D::Deserializer* deserializer_;
    };
}
