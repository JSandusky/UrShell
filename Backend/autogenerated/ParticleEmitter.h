...
namespace UrhoBackend {
    ...
    public ref class ParticleEmitter : public UrhoBackend::Drawable {
    public:
        ParticleEmitter(Urho3D::ParticleEmitter* comp);
        ParticleEmitter(System::IntPtr^ ptr);
...
// Properties
        ...
        property ParticleEffect^ effect { ParticleEffect^ get(); void set(ParticleEffect^); }
        property unsigned numParticles { unsigned get(); void set(unsigned); }
        property bool emitting { bool get(); void set(bool); }
        property bool serializeParticles { bool get(); void set(bool); }
// Methods
        void Commit();
...
// Fields
        ...
        Urho3D::ParticleEmitter* particleemitter_;
    };
}
